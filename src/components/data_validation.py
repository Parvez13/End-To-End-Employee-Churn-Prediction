...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = main_utils.convert_columns_float(df=base_df, exclude_columns=exclude_columns)
            train_df = main_utils.convert_columns_float(df=train_df, exclude_columns=exclude_columns)
            test_df = main_utils.convert_columns_float(df=test_df, exclude_columns=exclude_columns)
            ...
            main_utils.write_yaml_file(file_path=self.data_validation_config.report_file_path,
