...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> artifact_entity.DataTransformationArtifact:
        try:
            ...
            #save numpy array
            main_utils.save_numpy_array_data(file_path=self.data_transformation_config.transformed_train_path,
                                        array=train_arr)

            main_utils.save_numpy_array_data(file_path=self.data_transformation_config.transformed_test_path,
                                        array=test_arr)


            main_utils.save_object(file_path=self.data_transformation_config.transform_object_path,
             obj=transformation_pipleine)

            main_utils.save_object(file_path=self.data_transformation_config.target_encoder_path,
            obj=label_encoder)
